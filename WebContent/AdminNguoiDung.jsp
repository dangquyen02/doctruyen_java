                    ...
                    <div class="container-fluid px-4">
                        ...
                        <form action="AdminNguoiDungController" method="get" class="form-inline d-flex justify-content-between align-items-start flex-wrap">
					        <div class="form-group">
					            ...
					            <input name="txtmanguoidung" type="text" value="${sessionScope.selectmand }" class="form-control mt-1" placeholder="Nhập mã mã người dùng">
					        </div>
					        <div class="form-group">
					            <label for="txttennguoidung">Tên người dùng:</label>
					            <input name="txttennguoidung" type="text" value="${sessionScope.selecttennd }" class="form-control mt-1" placeholder="Nhập tên người dùng">
					        </div>
					        <div class="form-group">
					            <label for="txttendangnhap">Tên đăng nhập:</label>
					            <input name="txttendangnhap" type="text" value="${sessionScope.selecttendn }" class="form-control mt-1" placeholder="Nhập tên đăng nhập">
					        </div>
					        <div class="form-group">
		                            ...
		                            <tbody>
		                                <c:forEach items="${dsnguoidung}" var="nguoidung">
		                                    <tr>
		                                        ...
		                                        <td><a class="text-decoration-none text-primary" href="AdminNguoiDungController?selectnd=${nguoidung.getManguoidung()}">${nguoidung.getHoten()}</a></td>
		                                        <td>${nguoidung.getTendangnhap()}</td>
		                                        <td>${nguoidung.getMatkhau()}</td>
		                                        <td><a class="text-decoration-none text-primary" href="AdminNguoiDungController?mnd=${nguoidung.getManguoidung()}&tab=xoa">Xóa</a> </td>
		                                    </tr>
		                                </c:forEach>
		                            </tbody>
		                        </table>

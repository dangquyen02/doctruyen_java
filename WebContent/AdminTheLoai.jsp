                   ...
                   <div class="container-fluid px-4">
                       ...
                       <form action="AdminTheLoaiController" method="get" class="form-inline d-flex justify-content-start align-items-center flex-wrap">
						    <div class="form-group me-2">
						        ...
						        <input name="txtmatheloai" type="text" value="${sessionScope.selectmatl }" class="form-control" placeholder="Nhập mã thể loại">
						    </div>
						    <div class="form-group">
						        <label for="txttentheloai">Tên thể loại:</label>
						        <input name="txttentheloai" type="text" value="${sessionScope.selecttentl }" class="form-control" placeholder="Nhập tên thể loại">
						    </div>
						    <div class="w-100"></div>
								    ...
								    <tbody>
								        <c:forEach items="${dstheloai}" var="theloai">
								            <tr>
								                ...
								                <td><a class="text-decoration-none text-primary" href="AdminTheLoaiController?selecttheloai=${theloai.getMatheloai()}"> ${theloai.getTentheloai()}</a></td>
								                <td><a  class="text-decoration-none text-primary" href="AdminTheLoaiController?mtl=${theloai.getMatheloai()}&tab=xoa">Xóa</a> </td>
								            </tr>
								        </c:forEach>
									    </tbody>
									</table>
